...
function Train_Neural_ODE(nn, U0, U0_test,
                    extra_parameters, extra_parameters2, extra_parameters_test, extra_parameters2_test,
                    num_epochs, train_loader, opt, eta, Signals, Signals_forecast, t, lamb, actual_id)
    ...
    if isfile("/home/juan.morales/ExploracionIntV3/4_layers/Parameters/$(actual_id)_Parameters.csv")
        theta = CSV.read("/home/juan.morales/ExploracionIntV3/4_layers/Parameters/$(actual_id)_Parameters.csv", DataFrame)
        p = Float32.(theta[:,1])
    end
    ...
    callback = function ()
        ...
        if iter % (length(train_loader)) == 0
            ...
            forecast_loss = loss_valid(Signals_forecast, t)
...
function main()
   ...
   # Tomamos 1 sigmas y 5 tamaños de compartimientos para cada sigma o sea 60 señales
    ...
    # Vamos a tomar 500 épocas para entrenar todas las arquitecturas
    epochs = 500
    ...
    architecture_loss, theta, loss_forecast = Train_Neural_ODE(nn, U0, U0_test, 
                                                               extra_parameters, extra_parameters2, extra_parameters_test, extra_parameters2_test,
                                                               epochs, train_loader, opt, eta, Signals_rep, Signals_test, t, lambd, actual_id)
    ...
    CSV.write("/home/juan.morales/ExploracionIntV3/4_layers/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    if isfile("/home/juan.morales/ExploracionIntV3/4_layers/Losses/$(actual_id)_losses.csv")
        df_losses = vcat(CSV.read("/home/juan.morales/ExploracionIntV3/4_layers/Losses/$(actual_id)_losses.csv", DataFrame), df_losses)
    end
    ...
    CSV.write("/home/juan.morales/ExploracionIntV3/4_layers/Losses/$(actual_id)_losses.csv", df_losses)
    ...
    CSV.write("/home/juan.morales/ExploracionIntV3/4_layers/Parameters/$(actual_id)_Parameters.csv", df_theta)
end
