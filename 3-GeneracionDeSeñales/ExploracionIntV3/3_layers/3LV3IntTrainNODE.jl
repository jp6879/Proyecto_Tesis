...
function Train_Neural_ODE(nn, U0, U0_test,
    ...
    if isfile("/home/juan.morales/ExploracionIntV3/3_layers/Parameters/$(actual_id)_Parameters.csv")
        theta = CSV.read("/home/juan.morales/ExploracionIntV3/3_layers/Parameters/$(actual_id)_Parameters.csv", DataFrame)
        p = Float32.(theta[:,1])
    end
...
function main()
   ...
   # Tomamos 1 sigmas y 5 tamaños de compartimientos para cada sigma o sea 60 señales
    ...
    CSV.write("/home/juan.morales/ExploracionIntV3/3_layers/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    if isfile("/home/juan.morales/ExploracionIntV3/3_layers/Losses/$(actual_id)_losses.csv")
        df_losses = vcat(CSV.read("/home/juan.morales/ExploracionIntV3/3_layers/Losses/$(actual_id)_losses.csv", DataFrame), df_losses)
    end
    ...
    CSV.write("/home/juan.morales/ExploracionIntV3/3_layers/Losses/$(actual_id)_losses.csv", df_losses)
    ...
    CSV.write("/home/juan.morales/ExploracionIntV3/3_layers/Parameters/$(actual_id)_Parameters.csv", df_theta)
end
