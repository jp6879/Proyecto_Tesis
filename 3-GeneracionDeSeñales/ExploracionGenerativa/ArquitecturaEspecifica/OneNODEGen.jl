...
extra_parameters_valid = Signals_rep_derivadas
...
CSV.write("/home/juan.morales/ExploracionGenerativa/ArquitecturaEspecifica/Parameters/$(actual_id)_ParametersV2.csv", df_parameters)
...
CSV.write("/home/juan.morales/ExploracionGenerativa/ArquitecturaEspecifica/Losses/$(actual_id)_lossesV2.csv", df_losses)