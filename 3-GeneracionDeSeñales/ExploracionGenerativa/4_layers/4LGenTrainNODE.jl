...
function Train_Neural_ODE(nn, U0, extra_parameters, extra_parameters2, 
    ...
    if isfile("/home/juan.morales/ExploracionGenerativa/4_layers/Parameters/$(actual_id)_Parameters.csv")
        theta = CSV.read("/home/juan.morales/ExploracionGenerativa/4_layers/Parameters/$(actual_id)_Parameters.csv", DataFrame)
        p = Float32.(theta[:,1])
    end
...
function main()
    ...
    CSV.write("/home/juan.morales/ExploracionGenerativa/4_layers/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    if isfile("/home/juan.morales/ExploracionGenerativa/4_layers/Losses/$(actual_id)_losses.csv")
        df_losses = vcat(CSV.read("/home/juan.morales/ExploracionGenerativa/4_layers/Losses/$(actual_id)_losses.csv", DataFrame), df_losses)
    end
    ...
    CSV.write("/home/juan.morales/ExploracionGenerativa/4_layers/Losses/$(actual_id)_losses.csv", df_losses)
    ...
    CSV.write("/home/juan.morales/ExploracionGenerativa/4_layers/Parameters/$(actual_id)_Parameters.csv", df_theta)
end
