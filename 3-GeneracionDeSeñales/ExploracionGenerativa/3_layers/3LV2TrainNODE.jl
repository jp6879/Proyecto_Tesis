...
function Train_Neural_ODE(nn, U0, extra_parameters, extra_parameters2, 
    ...
    if isfile("/home/juan.morales/ExploracionGenerativa/3_layers/Parameters/$(actual_id)_Parameters.csv")
        theta = CSV.read("/home/juan.morales/ExploracionGenerativa/3_layers/Parameters/$(actual_id)_Parameters.csv", DataFrame)
        p = Float32.(theta[:,1])
    end
...
function main()
    ...
    # Rectas de entrenamiento y de validación, es la misma porque son 2 puntos únicamente
    ...
    # Número de modelo
    # actual_id = 1
    actual_id = parse(Int128,ARGS[1]) + 18
    ...
    architecture_loss, theta, loss_forecast = Train_Neural_ODE(nn, U0, Signals_derivadas_valid, recta_param_train, Signals_derivadas_valid, epochs, train_loader, opt, eta, Signals_rep, Signals_valid, t, tvalid, lambd, actual_id)
    ...
    CSV.write("/home/juan.morales/ExploracionGenerativa/3_layers/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    if isfile("/home/juan.morales/ExploracionGenerativa/3_layers/Losses/$(actual_id)_losses.csv")
        df_losses = vcat(CSV.read("/home/juan.morales/ExploracionGenerativa/3_layers/Losses/$(actual_id)_losses.csv", DataFrame), df_losses)
    end
    ...
    CSV.write("/home/juan.morales/ExploracionGenerativa/3_layers/Losses/$(actual_id)_losses.csv", df_losses)
    ...
    CSV.write("/home/juan.morales/ExploracionGenerativa/3_layers/Parameters/$(actual_id)_Parameters.csv", df_theta)
end
