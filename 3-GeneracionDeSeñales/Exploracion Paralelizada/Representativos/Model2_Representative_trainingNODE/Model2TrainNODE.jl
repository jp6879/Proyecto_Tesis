...
function main()
    ...
    CSV.write("/home/juan.morales/Model2_Representative_trainingNODE/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    CSV.write("/home/juan.morales/Model2_Representative_trainingNODE/Losses/$(actual_id)_losses.csv", df_losses)
    ...
    CSV.write("/home/juan.morales/Model2_Representative_trainingNODE/Parameters/$(actual_id)_Parameters.csv", df_theta)
