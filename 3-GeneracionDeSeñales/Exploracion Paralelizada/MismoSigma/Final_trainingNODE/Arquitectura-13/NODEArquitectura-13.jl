...
read_loss_path = "C:\\Users\\Propietario\\Desktop\\ib\\Tesis_V1\\Proyecto_Tesis\\3-GeneracionDeSeñales\\Exploracion Paralelizada\\Final_trainingNODE\\Losses\\13_losses.csv"
...
savefig("C:\\Users\\Propietario\\Desktop\\ib\\Tesis_V1\\Proyecto_Tesis\\3-GeneracionDeSeñales\\Exploracion Paralelizada\\Final_trainingNODE\\Arquitectura-13\\Arquitectura_13_Signal_1.pdf")
...
savefig("C:\\Users\\Propietario\\Desktop\\ib\\Tesis_V1\\Proyecto_Tesis\\3-GeneracionDeSeñales\\Exploracion Paralelizada\\Final_trainingNODE\\Arquitectura-13\\Arquitectura_13_Signal_$(idx_mitad).pdf")
...
savefig("C:\\Users\\Propietario\\Desktop\\ib\\Tesis_V1\\Proyecto_Tesis\\3-GeneracionDeSeñales\\Exploracion Paralelizada\\Final_trainingNODE\\Arquitectura-13\\Arquitectura_13_Signal_$(size(Signals_test)[1]).pdf")

plot_predictions = plot(ttrain, Predict_Singals(U0[1], Signals_test_derivadas_train[:,1], ttrain), label = "Entrenamiento", xlabel = L"t", ylabel = L"S(t)", title = "Predicción de señales", lw = 2, color = :red, markershape = :circle, tickfontsize=12, labelfontsize=15, legendfontsize=11, framestyle =:box, gridlinewidth=1, xminorticks=10, yminorticks=10)
plot!(tforecast, Predict_Singals(U0[1], Signals_test_derivadas_train[:,1], tforecast), label = "Predicción", lw = 2, color = :orange, markershape = :utriangle, ls = :dash)

for i in 2:2:size(Signals_test)[1]
...
plot_predictions
savefig("C:\\Users\\Propietario\\Desktop\\ib\\Tesis_V1\\Proyecto_Tesis\\3-GeneracionDeSeñales\\Exploracion Paralelizada\\Final_trainingNODE\\Arquitectura-13\\Arquitectura_13_Predictions.pdf")