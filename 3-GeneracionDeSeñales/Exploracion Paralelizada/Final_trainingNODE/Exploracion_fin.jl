...
function Get_Signals_Data_Training(path_read, rango, lcms, sigmas, muestreo_corto, muestreo_largo, t)
...
function main()
    ...
    # Voy a tomar 100 señales elegidas tomando lcm de 1 hasta 1.5 μm y manteniendo σ = 1.0
    rango = 100:200:10000
    ...
    # Hasta que indice del vector de tiempos tomamos 
    idx_forecast = 25
    ...
    CSV.write("/home/juan.morales/Final_trainingNODE/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    CSV.write("/home/juan.morales/Final_trainingNODE/Losses/$(actual_id)_losses.csv", df_losses)

    df_theta = DataFrame(reshape(theta, length(theta), 1), :auto)

    CSV.write("/home/juan.morales/Final_trainingNODE/Parameters/$(actual_id)_Parameters.csv", df_theta)
...
###################################TESTING#########################################
# Voy a tomar 50 se�ales elegidas tomando lcm entre 0.5 mu m, y 1.48 mu m
# rango = 100:200:10000
# # rango = 1:100
