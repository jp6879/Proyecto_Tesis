...
function Train_Neural_ODE(nn, U0, extra_parameters, extra_parameters_valid ,num_epochs, train_loader, opt, eta, Signals, Signals_forecast, t, tforecast, lamb, actual_id)
    ...
    if isfile("/home/juan.morales/ExploracionPocosPuntos/3_layers/Parameters/$(actual_id)_Parameters.csv")
        theta = CSV.read("/home/juan.morales/ExploracionPocosPuntos/3_layers/Parameters/$(actual_id)_Parameters.csv", DataFrame)
        p = Float32.(theta[:,1])
    end
