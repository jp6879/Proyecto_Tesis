...
parameters = scatter(t, Signals_rep_derivadas, label = "Derivada de la señales de entrenamiento", xlabel = "t", ylabel = "Parametros Extra", lw = 2, tickfontsize=12, labelfontsize=15, legendfontsize=11, framestyle =:box, gridlinewidth=1, xminorticks=10, yminorticks=10)
scatter!(t, recta_param_train, label = "Recta", lw = 2, color = :red)
parameters_valid = scatter!(tvalid, Signals_derivadas_valid, label = "Derivada de la señales de validación", xlabel = "t", lw = 2, tickfontsize=12, labelfontsize=15, legendfontsize=11, framestyle =:box, gridlinewidth=1, xminorticks=10, yminorticks=10)

savefig("C:/Users/Propietario/Desktop/ib/Tesis_V1/Proyecto_Tesis/3-GeneracionDeSeñales/ExploracionCompleta/Imágenes/OneSignal_ParametersV2.png")
...
savefig("C:/Users/Propietario/Desktop/ib/Tesis_V1/Proyecto_Tesis/3-GeneracionDeSeñales/ExploracionCompleta/Imágenes/OneSignalv2_loss.png")
...
# plot!(t, Predict_Singals(U0, extra_parameters, extra_parameters2, t), label = "Entrenamiento", xlabel = "t", ylabel = "S(t)", title = "Predicción de señales", lw = 2, color = :red, markershape = :circle)
plot!(t, Predict_Singals(U0, extra_parameters_valid, extra_parameters2, t), label = "Prediccion", xlabel = "t", ylabel = "S(t)", title = "Predicción de señales", lw = 2, color = :orange, markershape = :utriangle, ls = :dash)
scatter!(tvalid, Signals_valid', label = "Puntos Utilizados", lw = 2, color = :blue, markershape = :star6, markersize = 8)

savefig("C:/Users/Propietario/Desktop/ib/Tesis_V1/Proyecto_Tesis/3-GeneracionDeSeñales/ExploracionCompleta/Imágenes/OneSignal_predicciónv2.png")