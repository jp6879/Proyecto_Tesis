...
plot_predictions = plot(ttrain, Predict_Singals(U0[1], Signals_derivadas_train[:,1], ttrain), color = :red, label = "Entrenamiento", markershape = :star6, ls = :dash, lw = 2)
plot!(plot_predictions, tforecast, Predict_Singals(U0[1], Signals_derivadas_train[:,1], tforecast), color = :orange, label = "Predicción", markershape = :utriangle, ls = :dash, lw = 2)
