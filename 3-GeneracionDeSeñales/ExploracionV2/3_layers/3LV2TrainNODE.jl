...
function main()
    ...
    CSV.write("/home/juan.morales/ExploracionV2/3_layers/Resultados/$(actual_id)_$(actual_layer)_$(actual_activation)_$(actual_optimizer)_$(actual_batch_size).csv", df_results_total)
    ...
    if isfile("/home/juan.morales/ExploracionV2/3_layers/Losses/$(actual_id)_losses.csv")
        df_losses = vcat(CSV.read("/home/juan.morales/ExploracionV2/3_layers/Losses/$(actual_id)_losses.csv", DataFrame), df_losses)
    end
    ...
    CSV.write("/home/juan.morales/ExploracionV2/3_layers/Losses/$(actual_id)_losses.csv", df_losses)
    ...
    CSV.write("/home/juan.morales/ExploracionV2/3_layers/Parameters/$(actual_id)_Parameters.csv", df_theta)
end
