...
nn = Chain(Dense(3, 5, activation),
            Dense(5, 16, activation),
...
CSV.write("/home/juan.morales/ExploracionV2/ArquitecturaEspecifica/Parameters/$(actual_id)_ParametersV2.csv", df_parameters)
...
CSV.write("/home/juan.morales/ExploracionV2/ArquitecturaEspecifica/Losses/$(actual_id)_lossesV2.csv", df_losses)