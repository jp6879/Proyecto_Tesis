...
savefig("../3-GeneracionDeSeñales/ExploracionV2/ArquitecturaEspecifica/Imagenes/OneSignal_SignalsV2.png")
...
if isfile("../3-GeneracionDeSeñales/ExploracionV2/ArquitecturaEspecifica/Parameters/$(actual_id)_ParametersV2.csv")
    theta = CSV.read("../3-GeneracionDeSeñales/ExploracionV2/ArquitecturaEspecifica/Parameters/$(actual_id)_ParametersV2.csv", DataFrame)
    p = Float32.(theta[:,1])
else
